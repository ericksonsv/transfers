...
class OperationReport extends Page implements HasTable
{
    ...
    protected static ?string $title = 'Reporte de Operaciones';

    protected static string $view = 'filament.pages.operation-report';
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('note')
                    ...
                    ->badge()
                    ->action(
                    Action::make('Nota Servicio')
                        ->modal()
                        ->modalContent(fn(Service $record) => view('admin.reports.notes', ['record' => $record]))
            ...
            ->bulkActions([
                ExportBulkAction::make('Exportar Seleccionados')
                    ...
                    ->exporter(OperationReportExporter::class)
            ]);
    }
}
